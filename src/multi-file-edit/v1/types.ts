...
export interface LlmGeneratedPatchXmlV1 {
  /**
   * - I have updated the type to be a string instead of a string array, make
   * changes acordingly across the files
   ...
   * tags. - Next update the code where we print out the plan to use the new
   * format. Use a simple string variable to keep track of the current plan
   * already printed and compute the delta to be printed next
   */
  plan: string[]
  changes: FileChange[]
  /**
