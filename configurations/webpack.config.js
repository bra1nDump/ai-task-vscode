...
module.exports = (env, argv) => {
  console.log(`Webpack Arguments: ${JSON.stringify(argv, null, 2)})}`);
  ...
  const extensionConfig = {
    ...
    plugins: [
      new webpack.DefinePlugin({
        'global.IS_PRODUCTION': argv.mode === 'production',
        'global.isTutorialNotificationEnabled': argv.mode !== 'production'
      }),
    ]
  };
